  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels ==
        ...
        // SE MUESTRAN MÁS PELÍCULAS CUANDO SE LLEGA AL FINAL DE LA LISTA
  ...
  void handleSearch(String query) {
    if (query.isNotEmpty) {
      Provider.of<MoviesProvider>(context, listen: false)
          ...
          .then((searchResults) {
        setState(() {
          // LA LISTA SE ACTUALIZA CON LOS RESULTADOS DE LA BÚSQUEDA
          // LA LISTA PERMANECE VACÍA SI NO HAY RESULTADOS
          _isSearching = true;
          scrollController.jumpTo(0); // REGRESA AL INICIO DE LA LISTA
        });
      });
    } else {
      setState(() {
        // SE MUESTRAN TODAS LAS PELÍCULAS SI EL CAMPO DE BÚSQUEDA ESTA VACÍO
        _isSearching = false;
      });
    }
  }
